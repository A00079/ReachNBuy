...
import ajio from '../assets/img/ajio.png';
import tataqcliq from '../assets/img/tataqcliq.png';
import Bewakoof from '../assets/img/bewakoof.jpg';
import MainSection from '../components/MainProductListing/index.js';
                    ...
                    <main class="flex-grow flex flex-row min-h-0">
                        <section class="flex flex-col flex-none overflow-auto w-24 hover:w-64 group lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
                            <div class="header p-4 flex flex-row justify-between items-center flex-none">
                                <div class="w-16 h-16 relative flex flex-shrink-0 bg-black w-10 h-10 p-2" style={{ filter: "invert(100%)" }}>
                                ...
                                <p class="text-black text-md font-bold hidden md:block group-hover:block">Filters</p>
                                <a href="#" class="block rounded-full hover:bg-gray-700 bg-black w-10 h-10 p-2 hidden md:block group-hover:block">
                            ...
                            <div class="text-sm text-center mr-8"><div class="p-1 border-4 border-orange-600 rounded-full"><div class="w-12 h-12 relative flex flex-shrink-0">
                                    <img class="shadow-md rounded-full w-full h-full object-cover"
                                        src={flipkart}
                                        alt=""
                                    />
                                </div></div><p className='text-black font-bold'>FlipKart</p></div>
                                <div class="text-sm text-center mr-8"><div class="p-1 border-4 border-orange-600 rounded-full"><div class="w-12 h-12 relative flex flex-shrink-0">
                                    <img class="shadow-md rounded-full w-full h-full object-cover"
                                        src={amazon}
                                        alt=""
                                    />
                                </div></div><p className='text-black font-bold'>Amazon</p></div>
                                <div class="text-sm text-center mr-8"><div class="p-1 border-4 border-orange-600 rounded-full"><div class="w-12 h-12 relative flex flex-shrink-0">
                                    <img class="shadow-md rounded-full w-full h-full object-cover"
                                        src={myntra}
                                        alt=""
                                    />
                                </div></div><p className='text-black font-bold'>Myntra</p></div>
                                <div class="text-sm text-center mr-8"><div class="p-1 border-4 border-orange-600 rounded-full"><div class="w-12 h-12 relative flex flex-shrink-0">
                                    <img class="shadow-md rounded-full w-full h-full object-cover"
                                        src={ajio}
                                        alt=""
                                    />
                                </div></div><p className='text-black font-bold'>Ajio</p></div>
                            </div>
                            <div class="active-users flex flex-row p-2 overflow-auto w-0 min-w-full">
                            <div class="text-sm text-center mr-8"><div class="p-1 border-4 border-orange-600 rounded-full"><div class="w-12 h-12 relative flex flex-shrink-0">
                                    <img class="shadow-md rounded-full w-full h-full object-cover"
                                        ...
                                        alt=""
                                    />
                                </div></div><p className='text-black font-bold'>Tata Cliq</p></div>
                                <div class="text-sm text-center mr-8"><div class="p-1 border-4 border-orange-600 rounded-full"><div class="w-12 h-12 relative flex flex-shrink-0">
                                    <img class="shadow-md rounded-full w-full h-full object-cover"
                                        src={Bewakoof}
                                        alt=""
                                    />
                                </div></div><p className='text-black font-bold'>Bewakoof</p></div>
                            </div>
